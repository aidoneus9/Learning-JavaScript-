...
// but it also returns, that deleted array or actually that deleted element
console.log(time);
console.log(
...
document.querySelector('button').addEventListener('click', function () {
  ...
  for (const [i, row] of rows.entries()) {
    ...
    // padEnd: when we want just empty spaces, we can actually omit this second argument and just call with 20.
  }
});
